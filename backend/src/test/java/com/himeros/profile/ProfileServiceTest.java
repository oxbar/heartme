...
class ProfileServiceTest {
 @Test void rejectsUnderageProfile(){
   ...
   var cmd=new ProfileService.UpsertCommand("Minor",null,LocalDate.now().minusYears(17),Gender.OTHER,null,null,null,null,null,18,99,100,true,Set.of(),Set.of(Gender.OTHER));
